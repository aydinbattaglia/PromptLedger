...
for (const dir of ['dist', 'dist/popup', 'dist/dashboard', 'dist/background', 'dist/content', 'dist/inject', 'dist/plans', 'dist/onboarding', 'dist/help', 'dist/icons']) {
...
const pagesConfig = {
  entryPoints: [
    ...
    { in: 'src/help/help.ts', out: 'help/help' },
  ],
  bundle: true,
  outdir: 'dist',
  target: ['chrome120'],
